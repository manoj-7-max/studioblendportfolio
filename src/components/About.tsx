      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              We're a team of passionate digital creators who believe that every
              brand has a unique story to tell. Our mission is to help you tell
              that story in the most compelling and engaging way possible.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={isVisible ? { opacity: 1, y: 0 } : {}}
              ...
              className="text-[#36454F]/80 mb-4 leading-relaxed"
            >
              From eye-catching videos to scroll-stopping social content, we
              combine creativity with data-driven strategy to deliver measurable
              results that matter.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              ...
              className="text-[#36454F]/80 mb-6 leading-relaxed"
            >
